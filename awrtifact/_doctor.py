"""Stack-aware `doctor` for awrtifact.
...
interesting failures live BETWEEN them. "awrtifact is installed" is not the useful
fact -- "awrtifact is installed and the thing it pairs with is not" is. This reports
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awrtifact needs at runtime, and a
